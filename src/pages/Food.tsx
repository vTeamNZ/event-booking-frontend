...
const FoodSelection: React.FC = () => {
  ...
  return (
    <>
      <SEO 
        title="Sri Lankan Food Menu" 
        description="Explore authentic Sri Lankan cuisine options available at our events. Pre-order delicious food with your event tickets for a complete cultural experience." 
        keywords={["Sri Lankan Food", "Event Catering", "Food Pre-Order", "Authentic Sri Lankan Cuisine", "Event Food Options"]}
      />
