              ...
              <div className="mb-8">
                <div className="bg-white rounded-lg shadow p-6">
                  <div className="text-center">
                    ...
                    <p className="text-sm text-gray-600 mb-4">View detailed ticket sales and revenue data for your events</p>
                    <Link
                      to="/organizer/sales"
                      className="bg-green-600 hover:bg-green-700 text-white px-6 py-2 rounded-md text-sm font-medium inline-flex items-center"
                    >
